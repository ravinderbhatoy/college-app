...
- [x] Timetable utility screen with department and semester selection
- [x] Contacts utility screen
- [x] Auth/profile placeholder screen
- [x] Shared UI shell and sample v1 data model
...
- [ ] Search and filters for notices
- [ ] Event posters/images
- [ ] Push notifications for urgent notices and placement updates
